                ...
                <div class="d-flex justify-content-between">
                    <div class="col-md-12 p-sm-0">
                        ...
                        <div style="border: 1px solid rgb(222, 226, 230);">
                            ...
                            <div class="row cert-header-print m-0 mt-2" style="display: flex" id="header_large_scale">
                                ...
                                <div class="col-md-6 text-center px-4 px-md-0">
                                    <p id="title1" style="margin-bottom: 0px; margin-top: 18px; font-weight: bold;font-size: 24px;">
